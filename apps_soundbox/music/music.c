...
//                set_flac_sys_freq(0);//set_sys_clk
        ...
        case MSG_HALF_SECOND:
			...
			Send_Data[0]=0x04;
			Send_Data[1]=play_time;
			Send_Data[2]=play_time>>8;
			Send_Data[3]=play_time>>16;
			Send_Data[4]=play_time>>24;
        ...
        case MSG_LOW_POWER:
            ...
            break;
		case MSG_VOL_MAX:
			puts("Music_Low_Power\n");
			volmax_end_f=1;
			pa_umute();
			music_prompt_play(mapi,BPF_VOLMAX_MP3,msg[0]);
			break;
		case MSG_VOL_MIN:
			pa_umute();
			music_prompt_play(mapi,BPF_VOLMIN_MP3,msg[0]);
			break;
